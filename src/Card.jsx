...
//ternary start
        ...
        <div style={{backgroundColor:"rgb(240, 240, 240)",height:"355px",width:"290px",overflow:"hidden"}}>

         <div style={{height:"50px",marginBottom:"8px"}}>
{
        ( 100-((Number(init[row].price)/(Number(init[row].price)+Number(init[row].off))*100).toFixed(0)) ) > 0 ?
...
<p style={{marginTop:"10px"}}> <DoneIcon style={{color:"#B12704"}}/> <span  style={{color:"#B12704"}}><b>Express</b></span> Get it by Tomorrow, <b> April {new Date().getDate()+1}</b> </p>
