...
export default function TelivisionCard(props) {
    ...
    useEffect(()=>{
        firebaseDb.child('Television').on("value",snapshot=>{
...
//ternary start
              Object.keys(init).sort((a, b) => init[a].price - init[b].price).map((row) => (
                ...
                <>
        <Grid className={classes.gridy} item lg={4} sm={6} xs={12} style={{marginBottom:"20px"}}>
        <div style={{width:"300px"}}>
        <div style={{backgroundColor:"white",height:"355px",width:"380px",overflow:"hidden"}}>
